...
//10:51:40
  initializeNotification() async {
    ...
    AndroidInitializationSettings(
        "toDo_img1"); //same name of the image es. tasklist.png che si trova
    //in drawable>res>main nella cartella android (11:34)
  ...
  scheduleNotification(int days, int hours, int minutes, int seconds,
      Task task) async {
